 ...
 */
- (nonnull instancetype)initWithA:(nonnull JMapWaypoint *)a b:(nonnull JMapWaypoint *)b c:(nullable JMapWaypoint *)c threshold:(nullable NSNumber *)threshold uTurnThreshold:(nullable NSNumber *)uTurnThreshold;
